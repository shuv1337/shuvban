...
## Decision
Project-level shortcuts belong in repo config so teams can share setup.

## Implemented Early
1. Extended `.kanbanana/config.json` to store shared shortcut entries (`id`, `label`, `command`, optional `icon`).
